%!TEX root = io2d.tex
\rSec0 [\iotwod.relrectangle] {Class \tcode{rel_rectangle}}
...
\rSec1 [\iotwod.relrectangle.synopsis] {\tcode{rel_rectangle} synopsis}
...
\rSec1 [\iotwod.relrectangle.cons] {\tcode{rel_rectangle} constructors}
...
\rSec1 [\iotwod.relrectangle.modifiers]{\tcode{rel_rectangle} modifiers}
...
\rSec1 [\iotwod.relrectangle.observers]{\tcode{rel_rectangle} observers}
