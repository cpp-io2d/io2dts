%!TEX root = io2d.tex
\rSec0 [pathfactory.pathrelcurveto] {Class \tcode{path_factory::path_rel_curve_to}}

\pnum
\indexlibrary{\idxcode{path_factory::path_rel_curve_to}}
The class \tcode{path_factory::path_rel_curve_to} describes an operation on a path group.
...
\rSec1 [pathfactory.pathrelcurveto.synopsis] {\tcode{path_factory::path_rel_curve_to} synopsis}
...
\rSec1 [pathfactory.pathrelcurveto.cons] {\tcode{path_factory::path_rel_curve_to} constructors and assignment operators}
...
\begin{itemdescr}
	\pnum
	\effects
	Constructs an object of type \tcode{path_factory::path_rel_curve_to}.
...
\rSec1 [pathfactory.pathrelcurveto.modifiers]{\tcode{path_factory::path_rel_curve_to} modifiers}

\indexlibrary{\idxcode{path_factory::path_rel_curve_to}!\idxcode{control_point_1}}
\indexlibrary{\idxcode{control_point_1}!\idxcode{path_factory::path_rel_curve_to}}
\begin{itemdecl}
    void control_point_1(const vector_2d& value) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\indexlibrary{\idxcode{path_factory::path_rel_curve_to}!\idxcode{control_point_2}}
\indexlibrary{\idxcode{control_point_2}!\idxcode{path_factory::path_rel_curve_to}}
\begin{itemdecl}
    void control_point_2(const vector_2d& value) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\indexlibrary{\idxcode{path_factory::path_rel_curve_to}!\idxcode{end_point}}
\indexlibrary{\idxcode{end_point}!\idxcode{path_factory::path_rel_curve_to}}
\begin{itemdecl}
    void end_point(const vector_2d& value) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\rSec1 [pathfactory.pathrelcurveto.observers]{\tcode{path_factory::path_rel_curve_to} observers}
...
\indexlibrary{\idxcode{path_factory::path_rel_curve_to}!\idxcode{type}}
\indexlibrary{\idxcode{type}!\idxcode{path_factory::path_rel_curve_to}}
\begin{itemdecl}
    virtual path_data_type type() const noexcept override;
\end{itemdecl}
\begin{itemdescr}
