%!TEX root = io2d.tex
\rSec0 [relcurveto] {Class \tcode{rel_curve_to}}

\rSec1 [relcurveto.synopsis] {\tcode{rel_curve_to} synopsis}
...
\rSec1 [relcurveto.intro] {\tcode{rel_curve_to} Description}
...
\rSec1 [relcurveto.cons] {\tcode{rel_curve_to} constructors and assignment operators}
...
\rSec1 [relcurveto.modifiers]{\tcode{rel_curve_to} modifiers}
...
\rSec1 [relcurveto.observers]{\tcode{rel_curve_to} observers}
