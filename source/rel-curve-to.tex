%!TEX root = io2d.tex
\rSec0 [pathdataitem.relcurveto] {Class \tcode{path_factory::path_rel_curve_to}}

\pnum
\indexlibrary{\idxcode{path_factory::path_rel_curve_to}}
The class \tcode{path_factory::path_rel_curve_to} describes an operation on a path geometry collection.
...
\rSec1 [pathdataitem.relcurveto.synopsis] {\tcode{path_factory::path_rel_curve_to} synopsis}
...
\rSec1 [pathdataitem.relcurveto.cons] {\tcode{path_factory::path_rel_curve_to} constructors and assignment operators}
...
\rSec1 [pathdataitem.relcurveto.modifiers]{\tcode{path_factory::path_rel_curve_to} modifiers}
...
\rSec1 [pathdataitem.relcurveto.observers]{\tcode{path_factory::path_rel_curve_to} observers}
