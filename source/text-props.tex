...
The \tcode{basic_text_props} class provides general state information that is applicable to the text rendering rendering and composing operations (\ref{\iotwod.surface.rendering}).
