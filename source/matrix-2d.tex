...
namespace std::experimental::io2d::v1 {
  ...
  public:
    ...
    constexpr static matrix_2d init_translate(vector_2d value) noexcept;
    constexpr static matrix_2d init_scale(vector_2d value) noexcept;
...
\begin{itemdecl}
constexpr matrix_2d& translate(vector_2d val) noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\effects
...
\begin{itemdecl}
constexpr matrix_2d& scale(vector_2d val) noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\effects
...
\indexlibrarymember{operator*}{matrix_2d}%
\begin{itemdecl}
constexpr vector_2d operator*(vector_2d v, const matrix_2d& m) noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\returns
