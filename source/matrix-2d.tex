...
\begin{itemize}
	...
	\item \tcode{(*this.m00() * *this.m11() - *this.m01() * *this.m10()) != 0.0}
\end{itemize}
...
\begin{itemdescr}
	...
	\pnum
	\errors
	\tcode{io2d_error::invalid_matrix} if \tcode{!isfinite(*this.m00()) || !isfinite(*this.m01()) || !isfinite(*this.m10()) || !isfinite(*this.m11()) || !isfinite(*this.m20()) || !isfinite(*this.m21())}.
\end{itemdescr}
