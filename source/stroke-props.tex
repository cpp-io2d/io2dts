...
\rSec0 [\iotwod.strokeprops] {Class \tcode{basic_stroke_props}}

\rSec1 [\iotwod.strokeprops.summary] {\tcode{basic_stroke_props} summary}

\pnum
The \tcode{basic_stroke_props} class provides state information that is applicable to the stroking operation (see: \ref{\iotwod.surface.rendering} and \ref{\iotwod.surface.stroking}).
