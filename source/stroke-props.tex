...
\pnum
The \tcode{stroke_props} class provides state information that is applicable to the Stroke rendering and composing operation (\ref{surface.rendering} and \ref{surface.stroking}).
...
%\exitexample
%
\rSec1 [strokeprops.synopsis] {\tcode{stroke_props} synopsis}
...
\rSec1 [strokeprops.cons] {\tcode{stroke_props} constructors}
...
\rSec1 [strokeprops.modifiers] {\tcode{stroke_props} modifiers}
...
\rSec1 [strokeprops.observers] {\tcode{stroke_props} observers}
...
\pnum
\returns
The \impldef{\idxcode{stroke_props}!\idxcode{max_miter_limit}} maximum allowable value of Miter Limit.
