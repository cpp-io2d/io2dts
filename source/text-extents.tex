%!TEX root = io2d.tex
\rSec0 [\iotwod.textextents] {Class \tcode{text_extents}}

\rSec1 [\iotwod.textextents.synopsis] {\tcode{text_extents} synopsis}
...
\rSec1 [\iotwod.textextents.intro] {\tcode{text_extents} Description}
...
\rSec1 [\iotwod.textextents.cons] {\tcode{text_extents} constructors and assignment operators}
...
\rSec1 [\iotwod.textextents.modifiers]{\tcode{text_extents} modifiers}
...
\rSec1 [\iotwod.textextents.observers]{\tcode{text_extents} observers}
