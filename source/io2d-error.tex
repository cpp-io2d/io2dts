...
\begin{libreqtab2}
 ...
 This is the result of an improper call to \tcode{path_factory::rel_curve_to},
 \tcode{path_factory::rel_line_to}, or \tcode{path_factory::rel_move_to} or is the result of a call to \tcode{path_factory::append} with malformed data. See 
 \\
 \tcode{invalid_matrix}
 ...
 & Invalid data was encountered in a \tcode{path} or a \tcode{path_factory}
 object.
 \enternote
