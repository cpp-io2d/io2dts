%!TEX root = io2d.tex
\rSec0 [pathdataitem.changematrix] {Class \tcode{path_factory::path_change_matrix}}

\rSec1 [pathdataitem.changematrix.synopsis] {\tcode{path_factory::path_change_matrix} synopsis}
...
\rSec1 [pathdataitem.changematrix.cons] {\tcode{path_factory::path_change_matrix} constructors and assignment operators}
...
\rSec1 [pathdataitem.changematrix.modifiers]{\tcode{path_factory::path_change_matrix} modifiers}
...
\rSec1 [pathdataitem.changematrix.observers]{\tcode{path_factory::path_change_matrix} observers}
