...
\pnum
Gradients have a \tcode{color_stop_group} as part of their observable state.

\pnum
The \tcode{color_stop} objects within them contribute to defining a brush which, when sampled from, returns a value that is interpolated based on those color stops.
