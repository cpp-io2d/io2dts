...
\pnum
All attempts to sample from a a degenerate linear gradient return the color \tcode{rgba_color::transparent_black()}. The remainder of \ref{gradients} is inapplicable to degenerate linear gradients.
...
\pnum
All attempts to sample from a \tcode{brush} object created using a degenerate radial gradient return the color \tcode{rgba_color::transparent_black()}. The remainder of \ref{gradients} is inapplicable to degenerate radial gradients.
