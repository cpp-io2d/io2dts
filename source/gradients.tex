...
\pnum
\begin{example}
Given a linear gradient with a begin point of \tcode{point_2d(0.0f, 0.0f)} and an end point of \tcode{point_2d(10.0f, 5.0f)}, a color stop offset value of 0.6f would correspond to the point \tcode{point_2d(6.0f, 3.0f)}.
\end{example}
