...
\pnum
A linear gradient for which the distance between its begin point and its end point is \tcode{point_2d::zero()} is a \term{degenerate linear gradient}.
...
\item the distance between the center point of its start circle and the center point of its end circle is \tcode{point_2d::zero()}; or,
