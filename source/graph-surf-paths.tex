...
\remarks
The internal data of the interpreted path should be in a form that is best suited to take advantage of the \underlyingrendandpresenttechs used by \tcode{X}.	\\ \rowsep
%%
%% 
%%
\tcode{X::paths::}	&
