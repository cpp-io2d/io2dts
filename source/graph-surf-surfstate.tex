...
\tcode{RE} denotes the type \tcode{X::surface_state_props::render_props_data_type},
\tcode{BR} denotes the type \tcode{X::surface_state_props::brush_props_data_type},
\tcode{CL} denotes the type \tcode{X::surface_state_props::clip_props_data_type},
\tcode{ST} denotes the type \tcode{X::surface_state_props::stroke_props_data_type},
\tcode{FP} denotes the type \tcode{X::surface_state_props::fill_props_data_type},
\tcode{MA} denotes the type \tcode{X::surface_state_props::mask_props_data_type},
\tcode{DA} denotes the type \tcode{X::surface_state_props::dashes_data_type}, \tcode{BB} denotes the type \tcode{basic_bounding_box<G>},
\tcode{IP} denotes the type \tcode{basic_interpreted_path<X>},
\tcode{FI} denotes the type \tcode{basic_figure_items<X>::figure_item}, \tcode{M} denotes the type \tcode{basic_matrix_2d<G>}, and
...
% render props
%
\tcode{X::surface_state_props::create_render_props(filter f = filter::good, M m = M\{\}, compositing op c = compositing_op::over)}	&
\tcode{RE}	&
\returns
An object \tcode{r}.	&
\postconditions
\tcode{r.fi == f}, \tcode{r.m == m}, and \tcode{r.c == c}.	\\ \rowsep
\tcode{X::surface_state_props::filtering(RA\& r, filter fi)}	&
\tcode{void}	&
	&
\postconditions
\tcode{r.fi == fi}.	\\ \rowsep
...
\postconditions
\tcode{ra.c == c}.	\\ \rowsep
\tcode{X::surface_state_props::filtering(const RA\& r)}	&
\tcode{filter}	&
\returns
\tcode{r.fi}.	&
	\\ \rowsep
...
% brush props
%
\tcode{X::surface_state_props::create_brush_props(wrap_mode w = wrap_mode::none, filter fi = filter::good, const M\& m = M\{\})}	&
\tcode{BR}	&
\returns
An object \tcode{b}.	&
\postconditions
\tcode{b.w == w}, \tcode{b.fi == fi}, and \tcode{b.m == m}.	\\ \rowsep
...
\tcode{X::surface_state_props::create_clip_props(\stdqualifier{}initializer_list<FI> il, fill_rule fr)}	&
\tcode{CL}	&
\returns
An object \tcode{c}.	&
\postconditions
...
\tcode{X::surface_state_props::clip(CL\& c, \stdqualifier{}initializer_list<FI> il)}	&
\tcode{void}	&
	&
\postconditions
...
% stroke props
%
\tcode{X::surface_state_props::create_stroke_props(float lw = 2.0f, line_cap lc = line_cap::none, line_join lj = line_join::miter, float ml = 10.0f, antialias aa = antialias::good)}	&
\tcode{ST}	&
\returns
An object \tcode{s}.	&
\requires
...
\postconditions
\tcode{s.lw == lw}, \tcode{s.lc == lc}, \tcode{s.lj == lj}, \tcode{s.ml == ml}, and \tcode{s.aa == aa}.	\\ \rowsep
...
\postconditions
\tcode{s.ml == ml}.	\\ \rowsep
\tcode{X::surface_state_props::anti_aliasing(ST\& s, antialias aa)}	&
\tcode{void}	&
\postconditions
\tcode{s.aa == aa}.	\\ \rowsep
...
\tcode{s.ml}.	&
	\\ \rowsep
\tcode{X::surfaces_state_props::anti_aliasing(const ST\& s)}	&
\tcode{antialias}	&
\returns
\tcode{s.aa}.	&
	\\ \rowsep
...
% fill_props
%
\tcode{X::surface_state_props::create_fill_props(fill_rule fr = fill_rule::winding, antialias aa = antialias::good)}	&
\tcode{FP}	&
\returns
An object \tcode{f}.	&
\postconditions
\tcode{f.fr == fr} and \tcode{f.aa == aa}.
	\\ \rowsep
\tcode{X::surface_state_props::fill_fill_rule(FP\& f, fill_rule fr)}	&
\tcode{void}	&
	&
\postconditions
\tcode{f.fr == fr}.
	\\ \rowsep
\tcode{X::surface_state_props::antialiasing(FP\& f, antialias aa)}	&
\tcode{void}	&
	&
\postconditions
\tcode{f.aa == aa}.
	\\ \rowsep
\tcode{X::surface_state_props::fill_fill_rule(const FP\& f)}	&
\tcode{fill_rule}	&
\returns
\tcode{f.fr}.	&
	\\ \rowsep
\tcode{X::surface_state_props::antialiasing(const FP\& f)}	&
\tcode{antialias}	&
\returns
\tcode{f.aa}.	&
	\\ \rowsep
...
\tcode{X::surface_state_props::create_dashes(float o, \stdqualifier{}initializer_list<float> il)}	&
\tcode{DA}	&
\returns
An object \tcode{d}.	&
\postconditions
