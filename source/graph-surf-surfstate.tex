...
\postconditions
\tcode{s.ml == ml}.	\\ \rowsep
\tcode{X::surface_state_props::antialiasing(ST\& s, antialias aa)}	&
\tcode{void}	&
\postconditions
\tcode{s.aa == aa}.	\\ \rowsep
...
\tcode{s.ml}.	&
	\\ \rowsep
\tcode{X::surfaces_state_props::antialiasing(const ST\& s)}	&
\tcode{antialias}	&
\returns
\tcode{s.aa}.	&
	\\ \rowsep
...
\tcode{f.fr == fr} and \tcode{f.aa == aa}.
	\\ \rowsep
\tcode{X::surface_state_props::fill_rule(FP\& f, fill_rule fr)}	&
\tcode{void}	&
	&
\postconditions
\tcode{f.fr == fr}.
...
\tcode{f.aa == aa}.
	\\ \rowsep
\tcode{X::surface_state_props::fill_rule(const FP\& f)}	&
\tcode{fill_rule}	&
\returns
\tcode{f.fr}.	&
	\\ \rowsep
