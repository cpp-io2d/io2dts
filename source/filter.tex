...
\pnum
The \tcode{filter} enum class specifies the type of filter to use when sampling from raster graphics data.
...
\pnum
\begin{note}
The only type of brush that has raster graphics data as its visual data is a brush with a brush type of \tcode{brush_type::surface}.
\end{note}
