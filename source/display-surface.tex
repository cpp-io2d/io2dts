...
\pnum
After each execution of the Draw Callback, the contents of the Back Buffer are transferred using sampling to the Display Buffer. The Display Buffer is then shown to the user via the \term{output device}.
