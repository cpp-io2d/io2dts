...
\rSec1 [displaysurface.misc] {\tcode{display_surface} miscellaneous behavior}%
...
\pnum
Other errors, if any, produced by this function are \impldefplain{display_surface!constructor}.
\end{itemdescr}
