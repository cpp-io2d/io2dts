%!TEX root = io2d.tex
\rSec0 [pathdataitem.moveto] {Class \tcode{move_to}}

\rSec1 [pathdataitem.moveto.synopsis] {\tcode{move_to} synopsis}
...
\rSec1 [pathdataitem.moveto.intro] {\tcode{move_to} Description}
...
\rSec1 [pathdataitem.moveto.modifiers]{\tcode{move_to} modifiers}
...
\rSec1 [pathdataitem.moveto.observers]{\tcode{move_to} observers}
