%!TEX root = io2d.tex
\rSec0 [pathfactory.pathabsmoveto] {Class \tcode{path_factory::path_move_to}}
...
\rSec1 [pathfactory.pathabsmoveto.synopsis] {\tcode{path_factory::path_move_to} synopsis}
...
\rSec1 [pathfactory.pathabsmoveto.cons] {\tcode{path_factory::path_move_to} constructors and assignment operators}
...
\rSec1 [pathfactory.pathabsmoveto.modifiers]{\tcode{path_factory::path_move_to} modifiers}
...
\rSec1 [pathfactory.pathabsmoveto.observers]{\tcode{path_factory::path_move_to} observers}
