...
\begin{itemdescr}
	...
	\pnum
	If the current point does not contain a value, the last-move-to point shall be set to \tcode{vector_2\{ radius * cos(angle1), -(radius * -sin(angle1)) \} + center}.
	
	\pnum
	The current point shall be set to \tcode{vector_2\{ radius * cos(angle2), -(radius * -sin(angle2)) \} + center}.
\end{itemdescr}
...
\begin{itemdescr}
	...
	\pnum
	If the current point does not contain a value, the last-move-to point shall be set to \tcode{vector_2\{ radius * cos(angle2), radius * -sin(angle2) \} + center}.
	
	\pnum
	The current point shall be set to \tcode{vector_2\{ radius * cos(angle1), radius * -sin(angle1) \} + center}.
\end{itemdescr}
...
\begin{itemdescr}
	\pnum
	\effects
	If the current point does not contain a value, adds a \tcode{path_data} object constructed from \tcode{path_factory::path_abs_move_to(pt0)} to the end of the path group.
	
	\pnum
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_abs_curve_to(pt0, pt1, pt2)} to the end of the path group.
...
\begin{itemdescr}
	...
	\pnum
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_abs_line_to(pt)} to the end of the path group.
...
\begin{itemdescr}
	\pnum
	\effects
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_abs_move_to(pt)} to the end of the path group.
...
\begin{itemdescr}
	...
	\effects
	\begin{enumerate}
	\item Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_abs_move_to(\{ r.x(), r.y() \})} to the end of the path group.
	
	\item Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_rel_line_to(\{ r.width(), 0.0 \})} to the end of the path group.
	
	\item Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_rel_line_to(\{ 0.0, r.height() \})} to the end of the path group.
...
\begin{itemdescr}
	...
	\pnum
	\effects
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_rel_curve_to(dpt0, dpt1, dpt2)} to the end of the path group.
...
\begin{itemdescr}
	...
	\pnum
	\effects
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_rel_line_to(pt)} to the end of the path group.
...
\begin{itemdescr}
	...
	\pnum
	\effects
	Adds a \tcode{path_data} object constructed from \tcode{path_factory::path_rel_move_to(dpt)} to the end of the path group.
...
\begin{itemdescr}
	\pnum
	\returns
	A \tcode{rectangle} object which contains the extents of the path segments, including degenerate path segments, in the path group when it is processed as described in \ref{pathgeometries.processing}.
	\enternote
