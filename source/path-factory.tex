...
namespace std { namespace experimental { namespace io2d { inline namespace v1 {
  ...
  public:
    ...
    void add_text(const font_resource& fr, const string& utf8,
      const vector_2d& pt);
    void add_text(const font_resource& fr, const string& utf8,
      const vector_2d& pt, error_code& ec) noexcept;
    void add_glyph_run(const glyph_run& gr);
    void add_glyph_run(const glyph_run& gr, error_code& ec) noexcept;
    void clear() noexcept;
