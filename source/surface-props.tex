...
\pnum
It has a Surface Matrix of type \tcode{matrix_2d}, an Antialiasing Value of type \tcode{antialias}, and a Compositing Operator of type \tcode{compositing_op}.
...
\pnum
The value of Antialiasing Value is \tcode{antialias::good}.
...
\pnum
The value of Antialiasing Value is \tcode{a}.
...
\indexlibrary{\idxcode{surface_props}!\idxcode{antialiasing}}
\begin{itemdecl}
constexpr void antialiasing(antialias a) noexcept;
\end{itemdecl}
\begin{itemdescr}
