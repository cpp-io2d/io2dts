%!TEX root = io2d.tex
\rSec0 [absrectangle] {Class \tcode{abs_rectangle}}
...
\rSec1 [absrectangle.synopsis] {\tcode{abs_rectangle} synopsis}
...
\rSec1 [absrectangle.cons] {\tcode{abs_rectangle} constructors}
...
\rSec1 [absrectangle.modifiers]{\tcode{abs_rectangle} modifiers}
...
\rSec1 [absrectangle.observers]{\tcode{abs_rectangle} observers}
