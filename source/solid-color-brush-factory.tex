%!TEX root = io2d.tex
\rSec0 [solidcolorbrushfact] {Class \tcode{solid_color_brush_factory}}

\rSec1 [solidcolorbrushfact.synopsis] {\tcode{solid_color_brush_factory} synopsis}
...
\rSec1 [solidcolorbrushfact.intro] {\tcode{solid_color_brush_factory} Description}
...
\rSec1 [solidcolorbrushfact.cons] {\tcode{solid_color_brush_factory} constructors and assignment operators}
...
\rSec1 [solidcolorbrushfact.modifiers] {\tcode{solid_color_brush_factory} modifiers}
...
\rSec1 [solidcolorbrushfact.observers] {\tcode{solid_color_brush_factory} observers}
