...
\pnum
The \tcode{brush_type} enum class denotes a \tcode{brush} object's type.
\enternote
Since a \tcode{brush} can only be formed using one of the brush factory 
types, this enum class is described in terms of which brush factory was used 
to form the \tcode{brush} which has a particular \tcode{brush_type}.
\exitnote
