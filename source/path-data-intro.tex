...
\pnum
The \tcode{basic_path_builder} class template is a sequential container that contains a path. It provides a simple interface for building a path. A path can also be created using any container that stores \tcode{basic_figure_items<GraphicsSurfaces>::figure_item} objects.
