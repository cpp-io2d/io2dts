%!TEX root = io2d.tex
\rSec0 [rellineto] {Class \tcode{rel_line_to}}

\rSec1 [rellineto.synopsis] {\tcode{rel_line_to} synopsis}
...
\rSec1 [rellineto.intro] {\tcode{rel_line_to} Description}
...
\rSec1 [rellineto.cons] {\tcode{rel_line_to} constructors and assignment operators}
...
\rSec1 [rellineto.modifiers]{\tcode{rel_line_to} modifiers}
...
\rSec1 [rellineto.observers]{\tcode{rel_line_to} observers}
