%!TEX root = io2d.tex
\rSec0 [pathfactory.pathabscurve] {Class \tcode{path_factory::path_abs_curve}}

\pnum
\indexlibrary{\idxcode{path_factory::path_abs_curve}}
The class \tcode{path_factory::path_abs_curve} describes a path segment that is a cubic \bezierlocal curve.
...
\rSec1 [pathfactory.pathabscurve.synopsis] {\tcode{path_factory::path_abs_curve} synopsis}
...
\rSec1 [pathfactory.pathabscurve.cons] {\tcode{path_factory::path_abs_curve} constructors}

\indexlibrary{\idxcode{path_factory::path_abs_curve}!constructor}
\begin{itemdecl}
...
\begin{itemdescr}
	\pnum
	\effects
	Constructs an object of type \tcode{path_factory::path_abs_curve}.
...
\rSec1 [pathfactory.pathabscurve.modifiers]{\tcode{path_factory::path_abs_curve} modifiers}

\indexlibrary{\idxcode{path_factory::path_abs_curve}!\idxcode{control_point_1}}
\indexlibrary{\idxcode{control_point_1}!\idxcode{path_factory::path_abs_curve}}
\begin{itemdecl}
    void control_point_1(const vector_2d& cp) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\indexlibrary{\idxcode{path_factory::path_abs_curve}!\idxcode{control_point_2}}
\indexlibrary{\idxcode{control_point_2}!\idxcode{path_factory::path_abs_curve}}
\begin{itemdecl}
    void control_point_2(const vector_2d& cp) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\indexlibrary{\idxcode{path_factory::path_abs_curve}!\idxcode{end_point}}
\indexlibrary{\idxcode{end_point}!\idxcode{path_factory::path_abs_curve}}
\begin{itemdecl}
    void end_point(const vector_2d& ep) noexcept;
\end{itemdecl}
\begin{itemdescr}
...
\rSec1 [pathfactory.pathabscurve.observers]{\tcode{path_factory::path_abs_curve} observers}
