%!TEX root = io2d.tex
\rSec0 [newsubpath] {Class \tcode{new_sub_path}}

\rSec1 [newsubpath.synopsis] {\tcode{new_sub_path} synopsis}
...
\rSec1 [newsubpath.intro] {\tcode{new_sub_path} Description}
...
\rSec1 [newsubpath.observers]{\tcode{new_sub_path} observers}
