...
\begin{libreqtab2}
 ...
 \\ \rowsep
 \tcode{xrgb16}
 & A 16-bit RGB color model pixel format. There is a red color channel, a green color channel, and a blue color channel. The number of bits, byte order, and interpretation of values within each channel are \impldef{format::xrgb16}.
 \\ \rowsep
 \tcode{a8}
