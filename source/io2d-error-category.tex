%!TEX root = io2d.tex
\rSec0 [\iotwod.\iotwoderrorcategory] {Class \tcode{io2d_error_category}}

\rSec1 [\iotwod.\iotwoderrorcategory.intro] {\tcode{io2d_error_category} 
Description}

\pnum
\indexlibrary{\idxcode{io2d_error_category}}%
The \tcode{io2d_error_category} class derives from 
\tcode{::std::error_category} in order to provide a custom error category for 
use by this library.

\rSec1 [\iotwod.\iotwoderrorcategory.synopsis] {\tcode{io2d_error_category} 
synopsis}
...
\rSec1 [\iotwod.\iotwoderrorcategory.observers] {\tcode{io2d_error_category} 
observers}

\rSec2 [\iotwod.\iotwoderrorcategory::name] {\tcode{io2d_error_category::name}}
...
\rSec2 [\iotwod.\iotwoderrorcategory::message] 
{\tcode{io2d_error_category::message}}
...
\rSec2 [\iotwod.\iotwoderrorcategory::equivalent] 
{\tcode{io2d_error_category::equivalent}}
...
\rSec1 [\iotwod.\iotwoderrorcategory.nonmembers] {\tcode{io2d_error_category} 
