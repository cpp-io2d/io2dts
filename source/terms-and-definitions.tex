...
\begin{note}
It is possible for the initial segment and final path segment to be the same path segment.
\end{note}
...
\term{segment} (\ref{\iotwod.defns.seg}), \term{new figure command} (\ref{\iotwod.defns.command.newfig}), \term{close figure command} (\ref{\iotwod.defns.command.closefig}), or \term{path instruction} (\ref{\iotwod.defns.pathcommand})
