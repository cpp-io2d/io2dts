%!TEX root = io2d.tex
\rSec0 [\iotwod.relmove] {Class \tcode{rel_move}}
...
\rSec1 [\iotwod.relmove.synopsis] {\tcode{rel_move} synopsis}
...
\rSec1 [\iotwod.relmove.cons] {\tcode{rel_move} constructors}
...
\rSec1 [\iotwod.relmove.modifiers]{\tcode{rel_move} modifiers}
...
\rSec1 [\iotwod.relmove.observers]{\tcode{rel_move} observers}
