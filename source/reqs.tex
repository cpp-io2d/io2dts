...
\rSec2 [\iotwod.req.namespace] {Namespaces and headers}
...
\pnum
Unless otherwise specified, references to other entities described in this technical specification are assumed to be qualified with \tcode{std::experimental::filesystem::v1::}, and references to entities
described in the C++ standard are assumed to be qualified with \tcode{std::}.

\rSec2 [\iotwod.req.macros] {Feature test macros}
...
\pnum
\tcode{#define __cpp_lib_experimental_io2d 201505
