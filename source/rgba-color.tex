...
\pnum
The \tcode{alpha} value of all of the predefined \tcode{rgba_color} static members in Table~\ref{tab:\iotwod.rgbacolor.members.values} is \tcode{255} except for \tcode{transparent_black}, which has an \tcode{alpha} value of \tcode{0}.
