...
The class \tcode{rgba_color} describes a four channel color using the RGBA color model.

\pnum
There are three color channels, red, green, and blue, each of which is a \tcode{float} value.

\pnum
There is also an alpha channel, which is a \tcode{float} value.
...
\pnum
\effects
Constructs an object of type \tcode{rgba_color}. The red channel is \tcode{r / 255.0f}. The green channel is \tcode{g / 255.0f}. The blue channel is \tcode{b / 255.0f}. The alpha channel is \tcode{a / 255.0f}.

\pnum
\remarks
This constructor shall not participate in overload resolution unless \tcode{\stdqualifier{}is_integral_v<T>} is \tcode{true}.
\end{itemdescr}
...
\pnum
\effects
Constructs an object of type \tcode{rgba_color}. The red channel is \tcode{static_cast<float>(r)}. The green channel is \tcode{static_cast<float>(g)}. The blue channel is \tcode{static_cast<float>(b)}. The alpha channel is \tcode{static_cast<float>(a)}

\pnum
\remarks
This constructor shall not participate in overload resolution unless \tcode{\stdqualifier{}is_floating_point_v<U>} is \tcode{true}.
\end{itemdescr}
...
\pnum
\effects
The red channel is \tcode{val / 255.0f}.

\pnum
\remarks
This function shall not participate in overload resolution unless \tcode{\stdqualifier{}is_integral_v<T>} is \tcode{true}.
\end{itemdescr}
...
\pnum
\effects
The red channel is \tcode{static_cast<float>(val)}.

\pnum
\remarks
This function shall not participate in overload resolution unless \tcode{\stdqualifier{}is_floating_point_v<U>} is \tcode{true}.
\end{itemdescr}
...
\pnum
\effects
The green channel is \tcode{val / 255.0f}.
...
\pnum
\effects
The green channel is \tcode{static_cast<float>(val)}.
...
\pnum
\effects
The blue channel is \tcode{val / 255.0f}.
...
\pnum
\effects
The blue channel is \tcode{static_cast<float>(val)}.
...
%\begin{enumerate}
%\item The red channel is set to \tcode{(r() / a()) * val / 255.0f;}
%\item The green channel is set to \tcode{(g() / a()) * val / 255.0f;}
%\item The blue channel is set to \tcode{(b() / a()) * val / 255.0f;}
%\item The alpha channel is set to \tcode{val / 255.0f}.
%\end{enumerate}
\pnum
\effects
The alpha channel is \tcode{val / 255.0f}.
...
%\begin{enumerate}
%\item The red channel is set to \tcode{(r() / a()) * val;}
%\item The green channel is set to \tcode{(g() / a()) * val;}
%\item The blue channel is set to \tcode{(b() / a()) * val;}
%\item The alpha channel is \tcode{val}.
%\end{enumerate}
\pnum
\effects
The alpha channel is \tcode{static_cast<float>(val)}.
...
\pnum
\effects
\tcode{r(\stdqualifier{}min(r() * rhs / 255.0f, 1.0f))}.

\pnum
\tcode{g(\stdqualifier{}min(g() * rhs / 255.0f, 1.0f))}.

\pnum
\tcode{b(\stdqualifier{}min(b() * rhs / 255.0f, 1.0f))}.

\pnum
\tcode{a(\stdqualifier{}min(a() * rhs / 255.0f, 1.0f))}.
...
\pnum
\effects
\tcode{r(\stdqualifier{}min(r() * static_cast<float>(rhs), 1.0f))}.

\pnum
\tcode{g(\stdqualifier{}min(g() * static_cast<float>(rhs), 1.0f))}.

\pnum
\tcode{b(\stdqualifier{}min(b() * static_cast<float>(rhs), 1.0f))}.

\pnum
\tcode{a(\stdqualifier{}min(a() * static_cast<float>(rhs), 1.0f))}.
...
\pnum
\remarks
This function shall not participate in overload resolution unless \tcode{\stdqualifier{}is_floating_point_v<T>} is \tcode{true}.
\end{itemdescr}
