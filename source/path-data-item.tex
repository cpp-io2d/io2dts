%!TEX root = io2d.tex
\rSec0 [\iotwod.pathdataitem] {Class \tcode{path_data_item}}

\rSec1 [\iotwod.pathdataitem.synopsis] {\tcode{path_data_item} synopsis}
...
\rSec1 [\iotwod.pathdataitem.intro] {\tcode{path_data_item} Description}
...
\rSec1 [\iotwod.pathdataitem.cons] {\tcode{path_data_item} constructors and assignment operators}
...
\rSec1 [\iotwod.pathdataitem.modifiers] {\tcode{path_data_item} modifiers}
...
\rSec1 [\iotwod.pathdataitem.observers] {\tcode{path_data_item} observers}
