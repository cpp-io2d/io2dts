...
\rSec1 [pathdataitem.functiontemplates] {\tcode{path_data_item} member function templates}

\pnum
The specializations of the \tcode{path_data_item::get} member function template are specified at \ref{pathdataitem.get}.
