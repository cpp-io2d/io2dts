%!TEX root = io2d.tex
\rSec0 [fontslant] {Enum class \tcode{font_slant}}

\rSec1 [fontslant.summary] {\tcode{font_slant} Summary}
...
\rSec1 [fontslant.synopsis] {\tcode{font_slant} Synopsis}
...
\rSec1 [fontslant.enumerators] {\tcode{font_slant} Enumerators}
\begin{libreqtab2}
