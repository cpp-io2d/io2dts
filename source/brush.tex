...
\pnum
A \tcode{brush} object has immutable \tcode{brush_type} data which indicates the type of brush factory that was used in creating the \tcode{brush} object (See Table \ref{tab:\iotwod.brushtype.meanings}).
