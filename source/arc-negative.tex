%!TEX root = io2d.tex
\rSec0 [pathdataitem.arcnegative] {Class \tcode{path_data_item::arc_negative}}

\pnum
\indexlibrary{\idxcode{path_data_item::arc_negative}}
The class \tcode{path_data_item::arc_negative} describes an operation on a path geometry collection.

\pnum
This operation creates a circular arc with counterclockwise rotation.

\pnum
The unit for the values passed to and returned by \tcode{path_data_item::arc_negative::angle_1} and \tcode{path_data_item::arc_negative::angle_2} is the radian.
