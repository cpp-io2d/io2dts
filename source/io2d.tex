...
\usepackage[pdftex,
            ...
            pdfcreator={Michael B. McLaughlin, Herb Sutter, Jason Zink, Guy Davidson},
            bookmarks=true,
...
\include{graphics-templated-design}
%% header synopsis
...
\include{colors}
\include{graphics-math}
\include{graphics-surfaces}
...
\include{p1062-response}
\include{p1225-response}
