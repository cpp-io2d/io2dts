...
\pnum
A \tcode{mapped_surface} object can only be created by the \tcode{surface::map} function. Creation of a \tcode{mapped_surface} object fails if the format of the pixel data would be \tcode{format::invalid} or \tcode{format::unknown}.
