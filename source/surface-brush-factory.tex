%!TEX root = io2d.tex
\rSec0 [\iotwod.surfacebrushfact] {Class \tcode{surface_brush_factory}}

\rSec1 [\iotwod.surfacebrushfact.synopsis] {\tcode{surface_brush_factory} synopsis}
...
\rSec1 [\iotwod.surfacebrushfact.intro] {\tcode{surface_brush_factory} Description}
...
\rSec1 [\iotwod.surfacebrushfact.cons] {\tcode{surface_brush_factory} constructors and assignment operators}
...
\rSec1 [\iotwod.surfacebrushfact.modifiers]{\tcode{surface_brush_factory} modifiers}
...
\begin{itemdescr}
	...
	\pnum
	\errors
	Any error condition documented for \tcode{surface::flush} (\ref{\iotwod.surface}).
...
\rSec1 [\iotwod.surfacebrushfact.observers]{\tcode{surface_brush_factory} observers}
