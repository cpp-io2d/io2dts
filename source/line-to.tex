%!TEX root = io2d.tex
\rSec0 [pathdataitem.lineto] {Class \tcode{line_to}}

\rSec1 [pathdataitem.lineto.synopsis] {\tcode{line_to} synopsis}
...
\rSec1 [pathdataitem.lineto.intro] {\tcode{line_to} Description}
...
\rSec1 [pathdataitem.lineto.cons] {\tcode{line_to} constructors and assignment operators}
...
\rSec1 [pathdataitem.lineto.modifiers]{\tcode{line_to} modifiers}
...
\rSec1 [pathdataitem.lineto.observers]{\tcode{line_to} observers}
