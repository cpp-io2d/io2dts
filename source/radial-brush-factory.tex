...
\rSec1 [radialbrushfact.sizetype] {\tcode{radial_brush_factory::size_type}}

\pnum
The type of \tcode{radial_brush_factory::size_type} shall comply with the restrictions specified for the size_type of the collection of color stops that is part of the observable state of a gradient (\ref{gradients.colorstops}).
