...
\pnum
If evaluation of a figure item contained in a \tcode{figure_items::figure_item} during path interpretation results in the figure item becoming a degenerate segment, it effects are ignored and interpretation continues as-if that figure item did not exist.
