...
\pnum
The \tcode{refresh_style} enum class describes when the \term{draw callback} (Table~\ref{tab:\iotwod.outputsurface.state.listing}) of a \tcode{display_surface} object shall be called. See Table~\ref{tab:\iotwod.refreshstyle.meanings} for the meaning of each \tcode{refresh_style} enumerator.
