...
\pnum
\returns
A reference to the \tcode{basic_point_2d} object's data object (See: \ref{\iotwod.\pointtwod.intro}).
\end{itemdescr}
...
\pnum
\returns
\tcode{GraphicsMath::dot(data(), other)}.
\end{itemdescr}
...
\pnum
\returns
\tcode{GraphicsMath::magnitude(data())}.
\end{itemdescr}
...
\pnum
\returns
\tcode{GraphicsMath::magnitude_squared(data())}.
\end{itemdescr}
...
\pnum
\returns
\tcode{GraphicsMath::angular_direction(data())}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::to_unit(data()))}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to \tcode{data() = GraphicsMath::add(data(), rhs.data());}
...
\pnum
\effects
Equivalent to \tcode{data() = GraphicsMath::subtract(data(), rhs.data());}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::add(lhs.data(), rhs.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::negate(val.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::subtract(lhs.data(), rhs.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::multiply(lhs.data(), rhs.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::multiply(lhs.data(), rhs))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::multiply(lhs, rhs.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::divide(lhs.data(), rhs.data()))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::divide(lhs.data(), rhs))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_point_2d(GraphicsMath::divide(lhs, rhs.data()))}.
\end{itemdescr}
