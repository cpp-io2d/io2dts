...
\begin{libreqtab2}
 ...
 \exitexample
 \enternote
 The difference between \tcode{uniform} and \tcode{letterbox} is that \tcode{uniform} does not modify the contents of the display area that fall outside of the rectangle that the scaled render area is drawn in while \tcode{letterbox} fills those areas with the \tcode{display_surface} object's letterbox pattern.
 \exitnote
 \\
 \tcode{fill_uniform}
