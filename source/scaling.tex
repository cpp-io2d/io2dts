...
size of its render area. For information about the display area versus the render area, see the description of the \tcode{display_surface}~type\ref{displaysurface}. See 
