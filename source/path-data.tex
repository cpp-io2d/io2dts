%!TEX root = io2d.tex
\rSec0 [pathfactory.pathpathdata] {Class \tcode{path_data_item::path_data}}
...
\rSec1 [pathfactory.pathpathdata.synopsis] {\tcode{path_data_item::path_data} synopsis}
...
\rSec1 [pathfactory.pathpathdata.cons] {\tcode{path_data_item::path_data} constructors and assignment operators}
...
\rSec1 [pathfactory.pathpathdata.observers]{\tcode{path_data_item::path_data} observers}
