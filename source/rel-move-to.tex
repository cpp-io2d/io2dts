%!TEX root = io2d.tex
\rSec0 [relmoveto] {Class \tcode{rel_move_to}}

\rSec1 [relmoveto.synopsis] {\tcode{rel_move_to} synopsis}
...
\rSec1 [relmoveto.intro] {\tcode{rel_move_to} Description}
...
\rSec1 [relmoveto.cons] {\tcode{rel_move_to} constructors and assignment operators}
...
\rSec1 [relmoveto.modifiers]{\tcode{rel_move_to} modifiers}
...
\rSec1 [relmoveto.observers]{\tcode{rel_move_to} observers}
