...
\pnum
This section provides an informative example of how a properly formed \tcode{path_factory} object is interpreted in order to eliminate extraneous path instructions.
