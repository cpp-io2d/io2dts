%!TEX root = io2d.tex
\rSec0 [pathdataitem.closepath] {Class \tcode{path_data_item::close_path}}

\pnum
\indexlibrary{\idxcode{path_data_item::close_path}}
The class \tcode{path_data_item::close_path} describes an operation on a path geometry collection.
...
\rSec1 [pathdataitem.closepath.synopsis] {\tcode{path_data_item::close_path} synopsis}
...
\rSec1 [pathdataitem.closepath.observers]{\tcode{path_data_item::close_path} observers}
