%!TEX root = io2d.tex
\rSec0 [pathdataitem.closepath] {Class \tcode{close_path}}

\rSec1 [pathdataitem.closepath.synopsis] {\tcode{close_path} synopsis}
...
\rSec1 [pathdataitem.closepath.intro] {\tcode{close_path} Description}
...
\rSec1 [pathdataitem.closepath.observers]{\tcode{close_path} observers}
