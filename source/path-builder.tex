...
\pnum
A \tcode{basic_path_builder} is a contiguous container. (See [container.requirements.general] in \cppseventeen.)
...
namespace std::experimental::io2d::v1 {
  ...
  public:
    ...
    using size_type              = @\impdefx{type of \tcode{basic_path_builder::size_type}}@. // See [container.requirements] in \cppseventeen.
    using difference_type        = @\impdefx{type of \tcode{basic_path_builder::size_type}}@. // See [container.requirements] in \cppseventeen.
    using iterator               = @\impdefx{type of \tcode{basic_path_builder::iterator}}@. // See [container.requirements] in \cppseventeen.
    using const_iterator         = @\impdefx{type of \tcode{basic_path_builder::const_iterator}}@. // See [container.requirements] in \cppseventeen.
