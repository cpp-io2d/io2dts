...
namespace std::experimental::io2d::v1 {
  ...
  public:
    ...
    void new_path(point_2d pt) noexcept;
    void rel_new_path(point_2d pt) noexcept;
...
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{(path_data::abs_matrix(m)} to the end of the path group.
\end{itemdescr}
...
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{(path_data::rel_matrix(m)} to the end of the path group.
\end{itemdescr}
