...
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{(path_data::set_matrix(m)} to the end of the path group.
\end{itemdescr}
...
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{(path_data::modify_matrix(m)} to the end of the path group.
\end{itemdescr}
...
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{(path_data::revert_matrix()} to the end of the path group.
\end{itemdescr}

\indexlibrarymember{path_builder}{set_origin}%
\begin{itemdecl}
void set_origin(const vector_2d& pt) noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{path_data::set_origin(pt)} to the end of the path group.
\end{itemdescr}

\indexlibrarymember{path_builder}{modify_origin}%
\begin{itemdecl}
void modify_origin(const vector_2d& pt) noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{path_data::modify_origin(pt)} to the end of the path group.
\end{itemdescr}

\indexlibrarymember{path_builder}{revert_origin}%
\begin{itemdecl}
void revert_origin() noexcept;
\end{itemdecl}
\begin{itemdescr}
\pnum
\effects
Adds a \tcode{path_data::path_item} object constructed from \tcode{path_data::revert_origin()} to the end of the path group.
\end{itemdescr}
