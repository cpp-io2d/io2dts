...
\pnum
A \tcode{path} object is constructed from the path group data of a \tcode{path_factory} object. The path geometries of its path geometry graphics resource are immutable, however its path geometry graphics resource can be changed using copy assignment or move assignment.
